import{T as l,j as e,B as u}from"./index-cb8b8d5c.js";import{r as m,R as p}from"./index-f1286426.js";import{u as R}from"./tableProps-ec8c445c.js";import"./_commonjsHelpers-de833af9.js";import"./index-8d47fad6.js";import"./inheritsLoose-843c0be4.js";const x={title:"Tables/Select",component:l},f={useQueryOptions:R,columns:[{accessorKey:"uuid",header:"UUID"},{accessorKey:"name",header:"Name",enableSorting:!0,meta:{filterable:!0}},{accessorKey:"description",header:"Desc."},{accessorKey:"price",header:"€",enableSorting:!0}],crudOptions:{primaryKey:"uuid",canSelectRow:!0,canRefresh:!0},lazy:!1},t={render:()=>{const r=m.useRef(null),[s,d]=p.useState([]),i=()=>{r.current&&d(r.current.getSelectedRows().map(n=>({uuid:n.uuid,name:n.name})))};return e.jsxs(e.Fragment,{children:[e.jsx(u,{onClick:i,children:"Get selected rows"}),e.jsx(l,{tableProps:f,ref:r}),e.jsxs("div",{children:["Selected rows: ",s.length]}),e.jsx("div",{children:JSON.stringify(s)})]})}};var a,o,c;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
  render: () => {
...
//# sourceMappingURL=Select.stories-45dd7e98.js.map
